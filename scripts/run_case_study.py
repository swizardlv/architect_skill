"""真实案例测试脚本: 跨境金融清算与反洗钱推理系统 (CBS-Engine).

在目标目录 ~/code/arhitect_skill_tests 下执行全流程架构设计生命周期推演。
"""
...
# 将当前项目的 skills 目录加入 Python 搜索路径
REPO_ROOT = Path(__file__).parent.parent.resolve()
sys.path.insert(0, str(REPO_ROOT))
sys.path.insert(0, str(REPO_ROOT / "skills" / "00_orchestrator"))

from orchestrate_architecture_lifecycle import ArchitectureLifecycleFSM, FSMState
